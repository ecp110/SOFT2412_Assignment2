...
class CustomerPageTests {
    ...
    public void displayInitialTest() {
        CustomerPage cPage = new CustomerPage("app/src/main/java/movie/Databases/Movies.json", "app/src/main/java/movie/Databases/Locations.json", "app/src/main/java/movie/Databases/credit_cards.json", "app/src/main/java/movie/Databases/gift_cards.json", "app/src/main/java/movie/Databases/members.json", new User("user", "user", "customer"));
